 ...
 *
 *     Ext.ComponentQuery.query('field[fieldLabel^=Region], field[fieldLabel*=password]');
 *
 * E.g., the query above will match any field with field label starting with "Region",
 ...
 * backslash:
 *
 *     Ext.ComponentQuery.query('field[fieldLabel^="Region\\, foo"], field[fieldLabel*=password]');
 *
 * ## Pseudo classes
 *
