 ...
 *          
 *          manyToMany: {
 *              UserGroups: 'Region#'   // '#' is on the side (left or right) of Group
 *          }
 *      });
 *
 ...
 *      // "Region". Generated matrixName is now "GroupUsers".
 *      
 *      Ext.define('App.models.Group', {
 *          extend: 'Ext.data.Model',
 *          
    ...
    Left: Ext.define(null, {
        ...
        onStoreCreate: function(store, session, id) {
            ...
            if (session) {
                ...
                // is that of the Region to which these Groups are associated.
