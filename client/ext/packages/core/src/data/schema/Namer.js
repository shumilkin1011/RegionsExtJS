...
Ext.define('Ext.data.schema.Namer', {
    ...
    inverseFieldRole: function(leftType, unique, rightRole, rightType) {
        ...
        if (s1.toLowerCase() !== s2.toLowerCase()) {
            ...
            // reference to Region. This makes the right role "creator" so rather than
     ...
     * consider a Ticket entity with a "creatorId" field that references a Region entity.
    ...
    manyToOne: function(leftType, leftRole, rightType, rightRole) {
        ...
        //  Ticket (creator) -> Region ==> UserCreatorTickets
