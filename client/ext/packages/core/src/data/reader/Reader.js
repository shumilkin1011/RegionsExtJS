 ...
 * a Region, their Orders, OrderItems and Products. First we'll define the models:
 *
 *     Ext.define("Region", {
 ...
 *     });
 *
 * This may be a lot to take in - basically a Region has many Orders, each of which is composed of
 ...
 * sake), all of the Orders for each Region (again just 1 in this case), all of the OrderItems
 ...
 *
 *             // iterate over the Orders for each Region
