 ...
 *     });
 *
 * Now we can create instances of our Region model and call any model logic we defined:
 *
 *     var user = Ext.create('Region', {
 *         id   : 'ABCD12345',
 *         name : 'Conan',
 *         age  : 24,
 *         phone: '555-555-5555'
 ...
 *
 *     var instance = Ext.create('Region', {
 *         name: 'Ed',
 *         gender: 'Male',
 *         username: 'edspencer'
 *     });
 ...
 *     user.save({
 *         success: function() {
 *             console.log('The Region was updated');
 *         }
 *     });
 *
 ...
 *     user.erase({
 *         success: function() {
 *             console.log('The Region was destroyed!');
 *         }
 *     });
 * 
...
Ext.define('Ext.data.Model', {
     ...
     * 
     *      Ext.define('MyApp.models.Region', {
     *          extend: 'Ext.data.Model',
     *
     *          fields: [
     *              { name: 'name' }
     ...
     *      });
     * 
     *      var nameOrdinal = MyApp.models.Region.fieldOrdinals.name;
     *      
     *      // or, if you have an instance:
     *
     *      var user = new MyApp.models.Region();
     ...
     * MyApp.model.Region with ID 123 will return 'user/123'.
     ...
     *     });
     *
     *     var user = new MyApp.model.Region({
     *         name: 'Foo'
     *     });
     *
     ...
     * recursively. For example if we have a Region which hasMany Orders, and each Order
