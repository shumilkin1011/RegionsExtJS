...
Ext.define('Ext.data.session.ChangesVisitor', {
    ...
    onMatrixChange: function(association, id1, id2, state) {
        var me = this,
            name = association.left.type, // e.g., "Region"
        ...
        //      groups: {
        //          C: {
        //              20: [ 30, 40 ]  // associate Region 20 w/Groups 30 & 40
        //          },
        //          D: {
        //              10: [ 50 ]  // disassociate Region 10 w/Group 50
        //          }
        //      }
        //  }
        result = me.result || (me.result = {});
        bucket = result[name] || (result[name] = {}); // Region
