topSuite("Ext.data.schema.Namer", ['Ext.data.ArrayStore'], function() {
    ...
    describe("Company", function() {
        ...
        describe("users", function() {
            ...
            it('users association should refer to Region', function() {
    ...
    describe("Department", function() {
        describe("company", function() {
            ...
            it('company association should refer to Region', function() {
        ...
        describe("approvedUsers", function() {
            ...
            it('approvedUsers association should refer to Region', function() {
        ...
        describe("qualifiedUsers", function() {
            ...
            it('qualifiedUsers association should refer to Region', function() {
        ...
        describe("manager", function() {
            ...
            it('manager association should refer to Region', function() {
    ...
    describe("User", function() {
        describe("company", function() {
            ...
            it('should have Region on the left', function() {
        ...
        describe("assigneeTickets", function() {
            ...
            it('should have Region on the right', function() {
