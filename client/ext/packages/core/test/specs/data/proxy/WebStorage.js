        ...
        describe("methods", function() {
            describe("getRecordKey", function() {
                ...
                it("should return a unique string with a string given", function() {
                    expect(proxy.getRecordKey("33")).toEqual("Region-33");
                });
    ...
    describe("reading", function() {
        ...
        describe("if not passed an id", function() {
            ...
            beforeEach(function() {
                ...
                fakeStorageObject.setItem('Region-2', '{"firstName":"Joe","lastName":"Smith","age":"50"}');
                fakeStorageObject.setItem('Region-3', '{"firstName":"Tim","lastName":"Jones","age":"41"}');
                fakeStorageObject.setItem('Region-4', '{"firstName":"Jim","lastName":"Smith","age":"33"}');
