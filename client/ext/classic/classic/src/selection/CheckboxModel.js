...
Ext.define('Ext.selection.CheckboxModel', {
    ...
    onColumnUnlock: function(lockable, column) {
        ...
        // Region has unlocked all columns and left only the expander column in the locked side.
    ...
    onColumnLock: function(lockable, column) {
        ...
        // Region has begun filling the empty locked side - migrate to the locked side..
