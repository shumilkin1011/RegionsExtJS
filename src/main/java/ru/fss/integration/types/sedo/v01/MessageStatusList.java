 ...
 *       &lt;sequence&gt;
 *         &lt;element name="statuses" type="{http://www.fss.ru/integration/types/sedo/v01}MessageStatus" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class MessageStatusList {
    ...
    public List<MessageStatus> getStatuses() {
        if (statuses == null) {
            statuses = new ArrayList<MessageStatus>();
        }
